...
"""Actor-critic policy wrapper around the QKAN-VQC fast-weight programmer.

Exposes ``QuantumFWPNet``, the network used by ``run_qkanvfwp.py``. The fast
...
from gated_qkanvfwp import FWP
