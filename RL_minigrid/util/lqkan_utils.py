...
"""Actor-critic policy wrapper around the linear-QKAN fast-weight programmer.

Exposes ``QuantumFWPNet``, the network used by ``run_lqkanfwp.py``. The fast
...
from gated_lqkanFWP import FWP
