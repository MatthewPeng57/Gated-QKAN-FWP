...
"""Actor-critic policy wrapper around the GQKANFWP fast-weight programmer.

Exposes ``QuantumFWPNet``, the network used by ``run_gqkanfwp.py``. The fast
